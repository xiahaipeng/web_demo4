"""
Django settings for web_demo4 project.
...
SECRET_KEY = 'x_p&n8x*pz$a5y_(iosrmq6#d1kfhg*j07ix$f&3p7u5!n0ir_'
...
WSGI_APPLICATION = 'web_demo4.wsgi.application'
